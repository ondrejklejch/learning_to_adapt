...
from learning_to_adapt.model import LHUC, Renorm, Multiply, SDBatchNormalization
from learning_to_adapt.utils import load_sd_batchnorm_dataset, load_lda, load_utt_to_spk, load_utt_to_pdfs
...
def create_sat_batchnorm_model(hidden_dim=350, lda_path=None, num_spks=None):
    ...
    for i, (kernel_size, dilation_rate) in enumerate(layers):
        ...
        x = SDBatchNormalization(num_spks, name="%s.batchnorm" % name)([x, spk_id])
